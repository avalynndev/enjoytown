...
export default function Removed() {
  return (
    <div className="relative min-h-screen bg-gradient-to-br from-gray-100 to-gray-300 dark:from-gray-900 dark:to-black">
      <Pattern variant="dots" />

      <div className="absolute inset-0 flex flex-col items-center justify-center px-6">
        <h2 className="font-heading text-center text-5xl font-extrabold leading-tight sm:text-6xl md:text-7xl lg:text-8xl">
        ...
        <p className="mt-6 max-w-3xl text-center text-lg font-light text-gray-700 dark:text-gray-300 md:text-xl lg:text-2xl">
